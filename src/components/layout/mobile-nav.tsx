      ...
      {isOpen && (
        ...
        <div className="px-6 py-4 border-b border-[#E5E5E5]">
          <Link
            href="/get-equipment"
            onClick={onClose}
            className="block w-full bg-accent text-white text-center font-bold py-3 rounded-sm hover:opacity-90 transition-all duration-200"
          >
            Request Equipment
          </Link>
        </div>
        ...
        {/* Nav Links */}
        <nav className="overflow-y-auto h-[calc(100%-65px-72px)]">
          {NAV_ITEMS.map((item) => {
              ...
              <div key={item.label}>
                {"children" in item && item.children ? (
                  <>
                    <button
                      ...
                      className={cn(
                        ...
                        "min-h-[48px] py-3 px-6 border-b border-[#E5E5E5]",
                    ...
                    {expandedItems.includes(item.label) &&
                      item.children.map((child) => (
                        <Link
                          ...
                          onClick={onClose}
                          className={cn(
                            "block min-h-[48px] py-3 pl-12 pr-6 border-b border-[#E5E5E5]",
                  ...
                  <Link
                    ...
                    onClick={onClose}
                    className={cn(
                      "flex items-center gap-2.5 min-h-[48px] py-3 px-6 border-b border-[#E5E5E5]",
